...
class Menu:
    ...
    def __game_title_display(self):
        ...
        start_game =  pygame.font.SysFont("Comic Sans MS", 100).render("FIERY DRAGON", True, "#b68f40")
    ...
    def __draw_select_player_button(self,text,button_pos):
        ...
        text = pygame.font.SysFont("Comic Sans MS", 50).render(text, True, "#d7fcd4") # Render the button text
